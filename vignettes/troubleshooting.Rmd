...
citation_files <- list.files(path = "Test_RIS", pattern = "\\.ris", full.names = TRUE)
...
refWoS <- read_citations("TEST_RIS/WoS.ris")
refDIM <- read_citations("TEST_RIS/DIM.ris")
refPQ <- read_citations("TEST_RIS/PQ.ris")
refLENS <- read_citations("TEST_RIS/LENS.ris")
refScopus <- read_citations("TEST_RIS/Scopus.ris")
refGS <- read_citations("TEST_RIS/GScholar.ris")
refIn <- read_citations("TEST_RIS/inciteful.ris")

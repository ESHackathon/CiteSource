...
combined_counts <- dplyr::bind_rows(refWoS_counts %>% mutate(Ref = "refWoS"),
                                    refDIM_counts %>% mutate(Ref = "refDIM"),
                                    refPQ_counts %>% mutate(Ref = "refPQ"),
                                    refLENS_counts %>% mutate(Ref = "refLENS"),
                                    refScopus_counts %>% mutate(Ref = "refScopus"),
                                    refGS_counts %>% mutate(Ref = "refGS"),
                                    refIn_counts %>% mutate(Ref = "refIn"))

...
This vignette will provide an example of how one may use CiteSource not only to speed up the process of benchmarking, as well as iterate the development of search strings and search strategies. 

...
Currently none of the code here is run - one the vignette is ready, remove eval = FALSE below.
...
#To install a package from GitHub, you'll need the remotes package
install.packages("remotes")
library(remotes)

#Use the remotes package to install CiteSource
...
citation_files <- list.files(path= "data/bibfiles", pattern = "\\.ris", full.names = TRUE)

---
title: "CiteSource - Example: Assessing Usefulness of Databases for Evidence Synthesis"
...
vignette: >
  %\VignetteIndexEntry{CiteSource - Example: Assessing Usefulness of Databases for Evidence Synthesis}
...
plot_contributions(n_unique,
  center = TRUE, facets = "cite_source"
)
...
unique_citations %>%
  dplyr::filter(str_detect(cite_label, "benchmark")) %>%

...
initial_records_search <- calculate_initial_records(unique_citations, target_labels = "search")
initial_record_table_search <- create_initial_record_table(initial_records_search)
initial_record_table_search

initial_records_all <- calculate_initial_records(unique_citations)
initial_record_table_all <- create_initial_record_table(initial_records_all)
initial_record_table_all

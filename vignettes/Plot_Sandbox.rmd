...
colnames(d_sur_count) <- c("Source", "D-SUR")
...
# Style the table using DT
datatable(citation_counts, 
          options = list(dom = 't', pageLength = nrow(citation_counts), 
                         columnDefs = list(list(visible = FALSE, targets = 0)))) %>% 
  formatStyle(names(citation_counts),
              backgroundColor = styleEqual("Total", "lightgray"),
              target = "row") %>%
  formatPercentage(c("Source Contribution %", "Source Unique Contribution %", "Source Unique %"), 1)

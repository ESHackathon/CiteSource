...
```{r}
#Create a table to show the difference between the initial number of records uploaded for each source, the number Database-Specific Unique Records (S-SUR) which is the count after internal deduplication, and the number of unique records that source provided after deduplication across all sources.

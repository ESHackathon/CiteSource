...
vignette: >
  %\VignetteIndexEntry{CiteSource-Example2}
...
## NOTE that short and long versions are seperate in the working_example data folder
citation_files <- list.files(path="/working_example/short", pattern = "\\.ris", full.names = TRUE)

...
match_citations <- function(formatted_citations){
  ...
  pairs <- pairs %>%
    dplyr::select(id1, id2, author1, author2, author, title1, title2, title, abstract1, abstract2, abstract, year1, year2, year, number1, number2, number, pages1, pages2, pages, volume1, volume2, volume, journal1, journal2, journal, isbn, isbn1, isbn2, doi1, doi2, doi, record_id1, record_id2, cite_label, cite_labels1, cite_labels2, cite_source, cite_sources1, cite_sources2, cite_string, citestrings1, citestrings2)
